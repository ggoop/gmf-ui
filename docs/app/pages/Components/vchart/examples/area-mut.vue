<template>
  <div>
    <md-vchart :md-data="data">
      <md-vscale x field="date" type="timeCat" mask="MM-DD" />
      <md-vscale y field="value" :tick-count="4" :max="300" />
      <md-vtooltip show-crosshairs show-value-in-legend />

      <md-varea series-field="city" shape="smooth" adjust="stack" />
      <md-vline series-field="city" shape="smooth" adjust="stack" />
    </md-vchart>
  </div>
</template>
