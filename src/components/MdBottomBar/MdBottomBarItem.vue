<template>
  <md-button class="md-bottom-bar-item" :class="itemClasses" :id="id" :disabled="mdDisabled" :md-ripple="MdBottomBar.type === 'fixed'" v-bind="attrs" v-on="$listeners" @click="setActiveItem">
