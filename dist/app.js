...
var startOfWeek = __webpack_require__(125)
...
var startOfISOWeek = __webpack_require__(26)
...
var composeArgs = __webpack_require__(56),
    ...
    getHolder = __webpack_require__(33),
    reorder = __webpack_require__(162),
    replaceHolders = __webpack_require__(16),
...
var getWrapDetails = __webpack_require__(154),
    insertWrapDetails = __webpack_require__(155),
    setToString = __webpack_require__(28),
...
var baseClamp = __webpack_require__(219),
    baseToString = __webpack_require__(90),
...
var _Start = __webpack_require__(95);

var _Start2 = _interopRequireDefault(_Start);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

if (!_vue2.default.gmfStart) {
  _vue2.default.gmfStart = new _Start2.default();
}
var st = _vue2.default.gmfStart;
exports.default = st;
...
var _MdEnumCache = __webpack_require__(245);

var _MdEnumCache2 = _interopRequireDefault(_MdEnumCache);

var _store2 = __webpack_require__(246);

var _store3 = _interopRequireDefault(_store2);

var _vueI18n = __webpack_require__(250);
    ...
    value: function run(options, mixin) {
      ...
      vueRouter.beforeEach(function (to, from, next) {
        if (to.meta.requiresAuth && !rootData.configs.user) {
          if ((0, _isString2.default)(rootData.configs.auth.route)) {
            next(rootData.configs.auth.route + "?continue=" + to.fullPath);
          } else {
            next((0, _extend2.default)({}, rootData.configs.auth.route, { query: { continue: to.fullPath } }));
          }
        } else {
          next();
        }
...
var _bind = __webpack_require__(132);
...
var _isUndefined = __webpack_require__(214);
...
var _startsWith = __webpack_require__(89);
...
var _forOwn = __webpack_require__(221);
...
var _spread = __webpack_require__(238);
...
function isStream(val) {
  return (0, _isObject2.default)(val) && isFunction(val.pipe);
}
...
var css = function css(element, name, value) {
  if (isDefined(value)) {
...
var style = function style(el, st) {
  _forEach2.default.forEach(st, function (value, key) {
    css(el, key, value);
  });
};
//驼峰命名法
...
var now = function now(formater) {
  formater = formater || 'YYYY-MM-DD HH:mm:ss';
  return (0, _format2.default)(new Date(), formater);
};
...
function fTime(time) {
  ...
  var ct = 0,
      ...
      fu = tu;
  if ((0, _isNumber2.default)(time)) {
    fu = time;
  } else if ((0, _isString2.default)(time)) {
  ...
  if (ct >= 3600 && ct < 86400) return parseInt(ct / 3600) + "小时" + lb;
...
var formatDecimal = function formatDecimal(num, options) {
  //precision:精度，保留的小数位数
  //unit:单位，0个，1十，2百，3千
  //quantile:分位数，默认3，表示千分位
  options = (0, _extend2.default)({}, { precision: 2, unit: 0, quantile: 3 }, options);
...
var getDayOfYear = __webpack_require__(120)
var getISOWeek = __webpack_require__(124)
var getISOYear = __webpack_require__(48)
var parse = __webpack_require__(6)
var isValid = __webpack_require__(127)
var enLocale = __webpack_require__(128)
...
var parse = __webpack_require__(6)
var startOfYear = __webpack_require__(121)
var differenceInCalendarDays = __webpack_require__(122)
...
var startOfDay = __webpack_require__(123)
...
var parse = __webpack_require__(6)
var startOfISOWeek = __webpack_require__(26)
var startOfISOYear = __webpack_require__(126)
...
var buildFormattingTokensRegExp = __webpack_require__(131)
...
var LazyWrapper = __webpack_require__(30),
    ...
    lodash = __webpack_require__(152);
...
var realNames = __webpack_require__(151);
...
var Stack = __webpack_require__(167),
    ...
    safeGet = __webpack_require__(75);
...
var baseIsDate = __webpack_require__(216),
    baseUnary = __webpack_require__(73),
    nodeUtil = __webpack_require__(74);
...
var apply = __webpack_require__(11),
    arrayPush = __webpack_require__(92),
    baseRest = __webpack_require__(27),
    castSlice = __webpack_require__(239),
    toInteger = __webpack_require__(34);
...
var _MdSnakeCase = __webpack_require__(244);

var _MdSnakeCase2 = _interopRequireDefault(_MdSnakeCase);
...
var wrapModule = {
  ...
  computed: {
    wrap: function wrap() {
      var app = (0, _MdSnakeCase2.default)(this.$route.params.app);
      var module = (0, _MdSnakeCase2.default)(this.$route.params.module);
      if (!(0, _startsWith2.default)(module, app) && module.indexOf('-') < 0) {
        return app + '-' + module;
      }
      return module;
    }
...
var gmfConfig = function () {
  function gmfConfig() {
    _classCallCheck(this, gmfConfig);
  ...
  _createClass(gmfConfig, [{
    key: 'route',
    value: function route(routes) {
      var _this = this;

      if ((0, _isArray2.default)(routes)) {
    ...
    value: function i18n(locale, name, _i18n) {
      if (name) {
        this.i18ns.messages[locale][name] = (0, _merge2.default)(this.i18ns.messages[locale][name], _i18n);
      } else {
        this.i18ns.messages[locale] = (0, _merge2.default)(this.i18ns.messages[locale], _i18n);
      }
    }
  }, {
    key: 'store',
    value: function store(_store) {
      if (!_store.name) return;
...
if (!_vue2.default.gmfConfig) {
  _vue2.default.gmfConfig = new gmfConfig();
  _vue2.default.prototype.$gmfConfig = _vue2.default.gmfConfig;
}
var config = _vue2.default.gmfConfig;
...
var enumCache = function () {
  function enumCache() {
    _classCallCheck(this, enumCache);

    this.storageKey = 'gmf.enum.' + window.location.host;
  }

  _createClass(enumCache, [{
    key: 'get',
    ...
    value: function set(value) {
      ...
      if (value.fields) {
        value.fields.forEach(function (item) {
          localStorage.setItem(_this.storageKey + '.' + value.name + ':' + item.name, JSON.stringify(item));
        });
      }
    }
  }, {
    key: 'getEnum',
    value: function getEnum(name, item) {
      if (!name || !item) return null;
      return JSON.parse(localStorage.getItem(this.storageKey + '.' + name + ':' + item));
    }
  }, {
    key: 'getEnumName',
    value: function getEnumName(name, item) {
      var v = this.getEnum(name, item);
      return v ? v.comment : '';
    }
  }]);
...
var _mutations = __webpack_require__(249);
...
var _types$SET_PAGE_TITLE;

var _vue = __webpack_require__(9);

var _vue2 = _interopRequireDefault(_vue);

var _mutationTypes = __webpack_require__(93);
...
exports.default = (_types$SET_PAGE_TITLE = {}, _defineProperty(_types$SET_PAGE_TITLE, types.SET_PAGE_TITLE, function (_ref, title) {
  var commit = _ref.commit;

  var name = document.querySelector('meta[property="og:site_name"]');
...
}), _defineProperty(_types$SET_PAGE_TITLE, types.CHANGE_THEME, function (_ref2, theme) {
  var commit = _ref2.commit;

  _vue2.default.material.theming.theme = theme;
  commit(types.CHANGE_THEME, theme);
}), _defineProperty(_types$SET_PAGE_TITLE, types.SET_APP_NAME, function (_ref3, name) {
  var commit = _ref3.commit;

  commit(types.SET_APP_NAME, name);
}), _types$SET_PAGE_TITLE);
...
exports.default = (_types$SET_PAGE_TITLE = {}, _defineProperty(_types$SET_PAGE_TITLE, types.SET_PAGE_TITLE, function (state, title) {
  state.pageTitle = title;
}), _defineProperty(_types$SET_PAGE_TITLE, types.SET_APP_NAME, function (state, name) {
  state.appName = name;
}), _defineProperty(_types$SET_PAGE_TITLE, types.SHOW_MENU, function (state) {
  state.menuVisible = true;
}), _defineProperty(_types$SET_PAGE_TITLE, types.HIDE_MENU, function (state) {
  state.menuVisible = false;
}), _defineProperty(_types$SET_PAGE_TITLE, types.CHANGE_THEME, function (state, theme) {
  state.theme = theme;
}), _types$SET_PAGE_TITLE);
