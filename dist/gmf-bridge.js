...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["GmfBridge"] = factory();
	else
		root["GmfBridge"] = factory();
...
var _MdCombineURLs = __webpack_require__(28);

var _MdCombineURLs2 = _interopRequireDefault(_MdCombineURLs);

var _lodash = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"lodash.pick\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
function _innerCallApi(conf) {
  if (CONFIG_DATA.state) {
    var c = (0, _lodash2.default)(conf, ['data', 'timeout', 'responseType', 'maxContentLength', 'params', 'headers', 'method', 'url', 'baseURL']);
...
var gmf = {
  config: function config(ORIG_CONF) {
    ...
    HTTP_API = _axios2.default.create({ baseURL: (0, _MdCombineURLs2.default)(CONFIG_COPY.host, 'api') });
    ...
    _axios2.default.post('sys/jsapi/config', CONFIG_COPY, { baseURL: (0, _MdCombineURLs2.default)(CONFIG_COPY.host, 'api') }).then(function (res) {
  ...
  checkApi: function checkApi(call_conf) {
    /*
    {apiList: ['chooseImage']success:function(res){}}
    */
  },
  callApi: function callApi(apiName, call_conf) {
